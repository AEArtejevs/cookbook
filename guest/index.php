...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['recipe_id'])) {
  ...
  FavoriteController::store($_SESSION['user_id'], $_POST['recipe_id']);
  header("Location: " . $_SERVER['REQUEST_URI']);
  exit;
}


$data = RecipeController::index($pdo, $_SESSION['user_id'] ?? null);
      ...
      <?php foreach ($recipes as $recipe): ?>
        <div class="border border-gray-200 bg-white rounded shadow dark:bg-gray-900 dark:border-gray-700 relative max-w-sm">
          ...
          <form method="POST" class="absolute top-2 right-2">
            ...
            <button type="submit"
              ...
              <?php if (in_array($recipe['id'], $favoriteRecipeIds)): ?>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-indigo-600" fill="currentColor"
          ...
          <div class="p-5 flex flex-col">
            ...
            <a href="../guest/show.php?id=<?= $recipe['id'] ?>"
